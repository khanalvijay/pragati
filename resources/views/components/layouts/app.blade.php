...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="noti bg-danger col-3 col-sm-1 font-weight-bold">Notice:</div><div class="mqscroll bg-primary col-9 col-sm-11"> This sample marquee. </div>
  </div></div>
        ...
        <nav class="navbar navbar-light navbar-expand-lg mainmenu">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul id="menu-main-menu" class="navbar-nav" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
              <li id="menu-item-29" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home menu-item-29 nav-item"><a wire:navigate itemprop="url" href="{{  url('') }}" class="nav-link"><span itemprop="name">Home</span></a></li>
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="footer-links clearfix mt-3 animated zoomIn" style="animation-delay:2s">
                ...
                <div class="footer-line"></div>
                <ul id="menu-quick-links" class="mt-3" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                  <li id="menu-item-1496" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1496"><a href="#">Annual Calender</a></li>
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="footer-links clearfix mt-3 animated zoomIn" style="animation-delay:3s">
                ...
                <div class="footer-line"></div>
                <ul id="menu-services" class="mt-3" itemscope itemtype="http://www.schema.org/SiteNavigationElement">
                  <li id="menu-item-993" class="menu-item menu-item-type-post_type menu-item-object-schemes menu-item-993"><a wire:navigate href="{{route('ShowRemit')}}">Remittance</a></li>
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="subsribe-wrap mt-3 animated zoomIn" style="animation-delay:4s">
                ...
                <div class="footer-line"></div>
                <div class="somethig">Not Available</div>
